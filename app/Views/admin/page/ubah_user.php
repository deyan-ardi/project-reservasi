            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                    ...
                    <div class="page-title">
                        ...
                        <h6 class="sub-heading">Anda dapat melakukan manajemen pada user/tamu/guest yang login pada
                            sistem bungalow yang
                            ada
                            melalui fitur ini
                        </h6>
                    </div>
    ...
    <div class="main-content">
        ...
        <div class="row gutters">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header">Data Member Bungalow</div>
                    <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    ...
                                    <label class="custom-file ml-3">
                                        ...
                                        <span class="custom-file-control">Pilih Foto User...</span>
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-check col-md-1">
                                        <label class="form-check-label">
                                            <input
                                                class="form-check-input <?php if ($validation->getError('jabatan')) : ?>is-invalid<?php endif ?>"
                                                required name="jabatan" value="3" type="radio" <?= $member; ?>>
                                            <div class="invalid-feedback">
                                                <?= $validation->getError('jabatan'); ?>
                                            </div>
                                            Member
